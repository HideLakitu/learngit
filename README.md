...
|-----|-------|--------|-------|----------------|--------------|
|DOS2019-FLAD|12322|_**0.9461**_|_**0.9256**_|"{'batch_size': 1024, 'dropout': 0.5, 'kernels': 64, 'learning_rate': 0.05, 'regularization': Early-Stopping}"|./sample-dataset/10t-10n-DOS2019-dataset-val.hdf5|
