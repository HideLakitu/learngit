...
|-----|-------|--------|-------|----------------|--------------|
|DOS2019-FLAD||10000||_**0.9461**_|{'batch_size': 1024, 'dropout': 0.5, 'kernels': 64, 'learning_rate': 0.1, 'regularization': None}"|./sample-dataset/10t-10n-DOS2019-dataset-val.hdf5|
